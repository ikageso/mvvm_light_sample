...
namespace mvvm_light_sample.Common
{
    ...
    public class Progress4MessageTrigger : TriggerBase<DependencyObject>
    {
        protected override void OnAttached()
        {
            ...
            Messenger.Default.Register<Progress4Message>(
                AssociatedObject,
        ...
        {
            Messenger.Default.Unregister<Progress4Message>(AssociatedObject);
