...
namespace mvvm_light_sample.Common
{
    ...
    public class Progress3MessageTrigger : TriggerBase<DependencyObject>
    {
        protected override void OnAttached()
        {
            ...
            Messenger.Default.Register<Progress3Message>(
                AssociatedObject,
        ...
        {
            Messenger.Default.Unregister<Progress3Message>(AssociatedObject);
